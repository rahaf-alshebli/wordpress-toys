...
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('top_store_col1_texthtml',  __( 'Add your content here', 'th-top' )));?>
</div>
...
<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>"><?php esc_html_e( 'Assign Above header menu', 'th-top' );?></a>
<?php }
...
<div class="content-widget">
  ...
  <a href="<?php echo esc_url( admin_url( 'widgets.php' ) ); ?>"><?php esc_html_e( 'Add Widget', 'th-top' );?></a>
  <?php }?>
</div>
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('top_store_col2_texthtml',  __( 'Add your content here', 'th-top' )));?>
</div>
<?php }elseif($content=='menu'){
if ( has_nav_menu('top-store-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('top_store_col3_texthtml',  __( 'Add your content here', 'th-top' )));?>
</div>
<?php }elseif($content=='menu'){
if ( has_nav_menu('top-store-above-menu' ) ){?>
<!-- Menu Toggle btn-->
...
<div class="below-header  <?php echo esc_attr($main_header_layout);?> <?php echo esc_attr($top_store_menu_alignment);?> <?php echo esc_attr($main_header_opt);?>">
  <div class="container">
    <div class="below-header-bar thnk-col-3">
        ...
        <div class="menu-category-list">
          <div class="toggle-cat-wrap">
            <p class="cat-toggle" tabindex="0">
              ...
              <span class="toggle-title"><?php _e('Category','th-top'); ?></span>
          ...
          <nav>
            ...
            <div class="menu-toggle">
              ...
              <span class="icon-text"><?php _e('Menu','th-top'); ?></span>
              </button>
            </div>
      ...
      <?php endif; }elseif($main_header_layout == 'mhdrsix'){?>
        <div class="below-header-col1">
              <div class="menu-category-list">
              <div class="toggle-cat-wrap">
                  <p class="cat-toggle">
                    ...
                    <span class="toggle-title"><?php echo esc_html(get_theme_mod('top_store_hdr_category_text', __( 'Category', 'top-store-pro' )));?></span>
                    <span class="toggle-icon"></span>
                  </p>
              </div>
              <?php top_store_product_list_categories(); ?>
        ...
        <div class="sider-inner">
          ...
          <div class="below-header-col3">
             <?php top_store_main_header_optn();?>
          </div>
<?php endif; 
       } ?>
    </div>
    ...
    $main_header_layout = get_theme_mod('top_store_main_header_layout','mhdrsix');
    $main_header_opt = get_theme_mod('top_store_main_header_option','callto');
    $top_store_menu_alignment = get_theme_mod('top_store_menu_alignment','center');
     ...
     <?php } ?>
      <div class="container">
        <div class="main-header-bar thnk-col-3">
          ...
          <?php  } elseif ($main_header_layout == 'mhdrsix'){?>
            <div class="main-header-col1">
            <span class="logo-content">
            <?php top_store_logo();?> 
          </span>
          ...
          ?>
           ...
           <div class="main-header-col3">
            <div class="thunk-icon-market">
            <?php top_store_header_icon_second($main_header_layout); ?> 
            <div class="cart-icon">
         <?php if(class_exists( 'WooCommerce' )){ 
